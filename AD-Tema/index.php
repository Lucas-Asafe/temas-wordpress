...
<div id="conteudo">
    <div id="content">
        <?php
        function pega_id($nome_da_categoria){
            $termo = get_term_by('name', $nome_da_categoria, 'category');
            return $termo->term_id;
        }
        $id_categoria_destaque=pega_id('Destaque');
        query_posts('cat=-'.$id_categoria_destaque.'&paged=' . $paged);
