...
?>
<div id="sidebar">
    <a href="<?php echo $linkFacebook; ?>" title="<?php echo $linkFacebook; ?>" target="_blank">
        <div id="facebook">
            <table>
                <tr>
                    <td>
    ...
    <a href="<?php echo $linkTwitter; ?>" title="<?php echo $linkTwitter; ?>" target="_blank">
        <div id="twitter">
            <table>
                <tr>
                    <td>
    ...
    ?>
<!--
    <div class="t_box" style="margin-top: 15px">
    ...
    <div class="t_box">
        ...
        <svg viewBox="0 0 150.00 30.00">
        <text x="0" y="15">Widget</text>
        </svg>
    </div><!--tbox
    <div class="box-widget" style="padding: 10px;">
        Banner do Widget
    </div><!--box-widget
    -->
</div><!--sidebar-->